...
def evalASTGCN(config):
    """
    Calculates the ASTGCN model's performance on the test set for each station. These metrics are written to a file
    ...
    for station in stations:
        for horizon in horizons:
            try:
                ...
                metric_file = f'Results/ASTGCN/{horizon} Hour Forecast/{station}/Metrics/metrics.txt'
                actual_vs_predicted_file = f'Results/ASTGCN/{horizon} Hour Forecast/{station}/Metrics/actual_vs_predicted.txt'
                ...
                print(f'And was saved to Results/ASTGCN/{horizon} Hour Forecast/{station}/Metrics/metrics.txt' ) 
